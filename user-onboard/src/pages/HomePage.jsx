        ...
        <div className="flex h-screen bg-gray-100">
          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <header className="flex justify-between items-center p-4 shadow-md bg-white">
              ...
              <div className="relative">
                <button onClick={toggleDropdown} className="flex items-center focus:outline-none">
                  {/* <ProfileImage base64Image={user.userImage.imageBase64} /> */}
            ...
            <main className="flex-1 overflow-y-auto p-4">
              ...
              <h1>Address: {user.address.address1} {user.address.address2}, {user.address.city}, {user.address.country}</h1> */}
              <h1>Email:  Tony Stark</h1>
              <h1>Address:  Avengers Tower, Newyork, America</h1>
              <h1>Preferences</h1>
              {preferenceCheckboxes || <p>No Preferences Exist for the user</p>}
            </main>
          </div>
        </div>
